			...
			<div class="mb-6 flex flex-wrap items-center justify-between gap-4">
				...
				<div class="flex flex-wrap items-center gap-2">
					...
					<button
						...
						class="flex items-center gap-2 rounded-lg bg-orange-700 px-4 py-2 text-white transition hover:bg-orange-800"
					...
					<button
						...
						disabled={!store.dbLoaded}
						class="flex items-center gap-2 rounded-lg bg-orange-600 px-4 py-2 text-white transition hover:bg-orange-700"
